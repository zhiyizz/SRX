    ...
    <div className={styles.safety}>
      {/* <div className={classNames(styles.group)}>
        <div className={styles['video-box']}>
          <video preload="none" poster={`${prefix}/safety/poster4.jpg`} controls>
            <source src={`${prefix}/safety/video4.mp4`} />
          </video>
          <div className={styles.copy}>
            <h3 className={styles.title}>eCruise Pro高级智能辅助驾驶系统</h3>
            <p>*别克世纪对更高级别的智能辅助驾驶功能也进行了硬件预埋，如支持自动变道、自动驶入和驶出匝道的智慧领航Navigation on Pilot(NOP)，以及V2X相关功能，后续将陆续通过OTA远程升级等方式进行功能开启。</p>
          </div>
