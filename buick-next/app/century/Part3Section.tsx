        ...
        <div className={classNames(styles.itemmod,styles['part3-item-2'])} ref={item2Ref}>
          <div className={styles.container}>
            ...
            <div className={classNames(styles.pic,{
              ...
              <AliImage src={combineUrl(prefix, data.slides[1].media?.url)} alt={data.slides[1].media?.alt || '被动安全'} width={792} height={546} />
              <div className={styles.line}></div>
              <div className={styles.details}><AliImage src={combineUrl(prefix, data.slides[1].slides![0].media?.url)} alt={data.slides[1].slides![0].media?.alt || '被动安全'} width={460} height={475} /></div>
