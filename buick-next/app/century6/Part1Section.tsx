    ...
    <div className={styles['fbi-container']} ref={fbiRef}>
      <div className={styles.itemmod} ref={item1Ref}>
        <div className={styles.container}>
          <div className={styles.info}>
            <h3>弘阔气度，诠释豪华</h3>
            <p className={styles.content}>超大全景双天窗、背光包覆流光氛围灯，无处不精心雕琢细节，造就豪华的私享之旅。新增釉青配色，取色自传统制瓷工艺中的珍品——天青釉。以现代工艺重现天青入釉之色，成就世纪臻品。</p>
          </div>
      ...
      <div className={classNames(styles.itemmod,styles['part1-item-2'])} ref={item2Ref}>
        <div className={styles.container}>
          ...
          <div className={styles.info}>
            <h3>豪华大尺寸车身</h3>
            <p className={styles.content}>大尺寸车身，坐享越级豪华。座舱长宽高5230*1980*1867mm，3130mm超长轴距。纵向内部乘员空间，带来二三排更充裕的膝部和腿部空间。后备箱容积高达612升，7座版更可扩容至1901升，纵深可达1112mm，满足更大储物需求。</p>
          </div>
          <div className={styles.pic}>
