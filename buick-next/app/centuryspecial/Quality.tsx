    ...
    <div className={styles.quality}>
      <div className={styles.group}>
        ...
        <div className={classNames(styles.copy,styles.middle)}>
          ...
          <p>搭载由第八代Ecotec 2.0T可变缸涡轮增压发动机、9速HYDRA-MATIC智能变速箱及48V轻混动系统组成的全新一代智能驱动系统，可实现最大功率174kW，峰值扭矩350牛·米，带来舒适平顺的尊享乘坐体验。</p>
        </div>
      </div>
      <div className={styles.group}>
      ...
      <div className={styles.group}>
        ...
        <div className={classNames(styles.copy,styles.right,styles.middle,styles['int-align'])}>
