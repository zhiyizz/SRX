    ...
    <div className={styles['fbi-container']} ref={fbiRef}>
      <div className={classNames(styles.itemmod,styles['part3-item-1'])} ref={item1Ref}>
        <div className={styles.container}>
          <div className={classNames(styles.info,styles.white)}>
            <h3>科技赋能，守护安全</h3>
            <p className={styles.content}>世纪兼顾被动安全、主动安全与健康安全，高强度车身与智能科技珠联璧合，更全面地守护驾乘者的安心之旅。可达到L2级别的eCruise Pro智能辅助驾驶系统守护驾乘者的安心之旅。</p>
          </div>
      ...
      <div className={classNames(styles.itemmod,styles['part3-item-2'])} ref={item2Ref}>
        <div className={styles.container}>
          ...
          <div className={classNames(styles.pic,{
            ...
            <div className={styles.details}><AliImage src={combineUrl(prefix, data.slides[1].slides![1].media.url)} alt={data.slides[1].slides![1].media.alt || '被动安全'} width={data.slides[1].slides![1].media.width} height={data.slides[1].slides![1].media.height} /></div>
      ...
      <div className={classNames(styles.itemmod,styles['part3-item-3'])} ref={item3Ref}>
        <div className={styles.container}>
          <div className={styles.info}>
            <h3>主动安全</h3>
            <p className={styles.content}>主动安全方面，别克世纪配备同级领先的eCruise Pro高级智能辅助驾驶系统，以尖端科技引领豪华MPV智慧安全出行。</p>
          </div>
          <div className={styles.pic}>
      ...
      <div className={styles.itemmod} ref={item4Ref}>
        <div className={styles.container}>
          <div className={styles.info}>
            <h3>健康座舱</h3>
            <p className={styles.content}>用智能读懂空气，让健康唾手可得。应对日益加剧的空气污染，世纪CENTURY搭载多项智能空气质量管理系统，从防护、监测、过滤等步骤，有效提升车内空气质量。确保给予用户更清新、更健康的车内环境。</p>
          </div>
          <div className={styles.pic}>
