...
function isDealerObject(val: any): val is DealerObject {
  return val && 'dealerCode' in val && 'dealerName' in val
}
...
function isPoint(val: any): val is Point {
  return val && 'lng' in val && 'lat' in val
}
