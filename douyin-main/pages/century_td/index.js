...
Page({
  data: {
    kv:'https://m.buick.com.cn/douyinapp/century/testdrive/kv.jpg?'+new Date().getTime(),
    td:'https://m.buick.com.cn/douyinapp/century/testdrive/td.jpg?'+new Date().getTime(),
    locationData:null,
    series:[],
    seriesIdx:0,
    dealer:null,
         ...
         if(res.statusCode === 200){
          tt.hideLoading();
           ...
           for(let i of res.data){
             if(i.flags.testdrive && (i.name === '昂扬' || i.name === '昂扬 GS')){
               arr.push(i)
             }
           }
           this.setData({
