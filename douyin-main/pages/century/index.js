...
Page({
  data: {
    img: {
      p1: 'https://m.buick.com.cn/douyinapp/century/img1.jpg?' + new Date().getTime(),
      p2: 'https://m.buick.com.cn/douyinapp/century/img2.jpg?' + new Date().getTime(),
      p3: 'https://m.buick.com.cn/douyinapp/century/img3.jpg?' + new Date().getTime(),
      p4: 'https://m.buick.com.cn/douyinapp/century/img4.jpg?' + new Date().getTime(),
      p5: 'https://m.buick.com.cn/douyinapp/century/img5.jpg?' + new Date().getTime(),
      button: 'https://m.buick.com.cn/douyinapp/century/button.jpg?' + new Date().getTime()
    }
  },
  onShareAppMessage(e) {
    return {
      path: '/pages/century/index',
      templateId:'c9qqaibo9b22o7jbif',
      success () {
  ...
  onClick(e) {
    tt.navigateTo({
      url: `../century_td/index?utm_campaign=${this.data.utm_campaign}&utm_content=${this.data.utm_content}&utm_medium=${this.data.utm_medium}&utm_source=${this.data.utm_source}&utm_term=${this.data.utm_term}`,
      success(res) {
