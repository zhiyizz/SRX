...
Page({
  data: {
    kv:'https://m.buick.com.cn/douyinapp/brand1214/testdrive/kv.jpg?'+new Date().getTime(),
    td:'https://m.buick.com.cn/douyinapp/brand1214/testdrive/td.jpg?'+new Date().getTime(),
    locationData:null,
    series:[],
    seriesIdx:0,
    dealer:null,
         ...
         if(res.statusCode === 200){
          tt.hideLoading();
           ...
           for(let i of res.data){
             if(i.flags.testdrive && (i.code === 'gl8_es' || i.code === 'envisionplus' ||  i.code === 'lacrosse' ||  i.code === 'lacrosse_avenir')){
               if(i.displayName === ''){
